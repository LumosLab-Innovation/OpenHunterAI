...
## Technical Requirements restored from 433ecf7970fdb5cbfbf47399e56bf006db719a85

Technical requirements for OpenHunterAI's black-box pentest workflow and MVP
architecture.

> This is the restored historical specification. The running stack is
> React/Vite, Express/TypeScript, Go, Postgres, and NATS; the technical
> catalogue below mixes implemented features and proposed tools. Current
> release gates, architecture, and guardrails take precedence.
